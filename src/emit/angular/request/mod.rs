//! The per-operation request surface: its interface, its builder and the
//! lines the builder writes.

mod interface;
mod lines;

use crate::emit::ts::{Writer, wln};
use crate::identifier::TypeName;
use crate::plan::artifact_plan::PlannedOperation;
...
use interface::{HeaderObject, request_members};
pub(super) use interface::{render_error_interface, render_request_interface};
use lines::{write_body_line, write_params_line, write_path_template_into};
